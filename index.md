...
season again is instant. Call
[`clear_cache()`](https://ramirobentes.github.io/nbadatar/reference/clear_cache.md)
to force a fresh download, which matters during the season when the
current season’s files change daily.
